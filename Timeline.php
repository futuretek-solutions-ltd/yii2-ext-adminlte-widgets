...
class Timeline extends Widget
{
     ...
     *      if(is_string($data)){
     *          return futuretek\adminlte\widget\Timeline::TYPE_BLUE;
     *      }elseif($data->type==1){
     *          return futuretek\adminlte\widget\Timeline::TYPE_LBLUE;
     *      }else{
     *         return futuretek\adminlte\widget\Timeline::TYPE_TEAL;
     *      }
     * }
     **/
